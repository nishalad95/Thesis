...
\begin{figure}[!htbp]%
    %\centerfloat
    \centering
    \subfloat[\centering Weakly connected graph networks]{{\includegraphics[width=0.51\textwidth]{images/5-gnn-algorithm/mc-example-3.png} } \label{fig:mc-example-3}}%
    %\qquad
    \subfloat[\centering Intermediate network state post GMR]{{\includegraphics[width=0.5\textwidth]{images/5-gnn-algorithm/mc-example-4.png} } \label{fig:mc-example-4}}%
    %\qquad
    \vskip\baselineskip
    \subfloat[\centering Extracted track candidates after stage 1]{{\includegraphics[width=0.8\textwidth]{images/5-gnn-algorithm/mc-example-5.png} } \label{fig:mc-example-5}}%
