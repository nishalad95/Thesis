...
In this chapter, a brief overview of the \ac{LHC} and the accelerator complex at CERN is given in Section \ref{the-lhc}. The ATLAS experiment and an overview of the different detector systems is provided in Section \ref{atlas-section}. Finally, the future of the \ac{LHC} experiment is presented in Section \ref{hi-lumi}, with a focus on the motivation and challenges that the High-Luminosity LHC (HL-LHC) phase will bring.
